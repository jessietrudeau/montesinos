...
df = pd.read_csv('/Users/franciscasaldivar/montesinos/data/modified_data/modified_data/1200.tsv', sep='\t')
...
df.to_csv('/Users/franciscasaldivar/montesinos/data/modified_data/modified_data/1200.tsv', sep='\t', index=False)
