...
file <- "../data/Transcript inventory.csv"
...
# Define file paths
inventory_file <- "../data/Transcript inventory.csv"
...
# Read the TSV file
file_path <- "../data/Transcript inventory.csv"
...
visit_summary <- visit_summary %>% filter(!is.na(Type))

# Create a bar plot to visualize the total visits for each type
ggplot(visit_summary, aes(x = reorder(Type, -total_visits), y = total_visits, fill = Type)) +
